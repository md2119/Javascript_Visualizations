...
links.Timeline = function(container, options) {
   ...
   // this.setOptions(options);
    ...
    this.itemTypes = {
		...
		triangleRight: links.Timeline.ItemTriangleRight
    };
...
links.Timeline.prototype.setData = function(data) {
    ...
    if (google && google.visualization &&
        ...
        for (var row = 0, rows = data.getNumberOfRows(); row < rows; row++) {
			...
			//document.getElementById("print").innerHTML = data.getValue(row, cols.start);
        }
    }
...
links.Timeline.prototype.setVisibleChartRangeNow = function() {
    ...
    var diff = (this.end.valueOf() - this.start.valueOf()) * 10;

    var startNew = new Date(now.valueOf() - diff);
...
links.Timeline.prototype.repaintAxis = function() {
    ...
    while (!step.end() && max < 1000) {
        ...
        if (options.showMinorLabels ) {
			...
			//document.getElementById("print").innerHTML = items.top;
        }
...
links.Timeline.prototype.repaintAxisMinorLine = function (x) {
    ...
    line.style.top =  axis.lineMinorHeight - 20 + "px";
   	
 //   line.style.bottom = "5px";
	line.style.height = "15px"; //axis.lineMinorHeight/5 + "px";
 ...
 * @override
 */
links.Timeline.ItemBox.prototype.select = function (options) {
    var dom = this.dom;

	if( jQuery.isEmptyObject(options.highlightbkcolor) ) {
		dom.style.background = "";
		dom.line.style.borderColor = "";
		dom.dot.style.borderColor = "";
		dom.style.borderColor = "";
	} else {
		dom.style.background = options.highlightbkcolor;
		dom.line.style.borderColor = options.highlightbkcolor;
		dom.dot.style.borderColor = options.highlightbkcolor;
		dom.style.borderColor = options.highlightbkcolor;
	}
	if( jQuery.isEmptyObject(options.highlightfrcolor) )
		dom.style.color = "";
	else
		dom.style.color = options.highlightfrcolor;
...
links.Timeline.ItemBox.prototype.unselect = function () {
	...
	if( jQuery.isEmptyObject(this.bkcolor) ) {
		dom.style.background = "";
		dom.style.borderColor = "";
		dom.line.style.borderColor = "";
		dom.dot.style.borderColor = "";
	} else {
		dom.style.background = this.bkcolor;
		dom.style.borderColor = this.bkcolor;
		dom.line.style.borderColor = this.bkcolor;
		dom.dot.style.borderColor = this.bkcolor;
	}
	
	if( jQuery.isEmptyObject(this.txtcolor) )	
		dom.style.color = "";
	else
		dom.style.color = this.txtcolor;
...
links.Timeline.ItemBox.prototype.createDOM = function () {
	...
	divBox.style.color = this.txtcolor;
	divBox.style.borderColor = this.bkcolor;
	divBox.style.background = this.bkcolor;
    ...
    divBox.line = divLine;
	divBox.line.style.borderColor = this.bkcolor;
    ...
    divBox.dot = divDot;
	divBox.dot.style.borderColor = this.bkcolor;
...
links.Timeline.ItemBox.prototype.updateDOM = function () {
 ...
 //       divTriangle.className  = "timeline-event timeline-event-tri ui-widget ui-state-default";
 ...
 //           links.Timeline.addClassName(divTriangle, 'timeline-event-cluster ui-widget-header');
        }
...
//			links.Timeline.addClassName(divTriangle, this.className);
        }
...
links.Timeline.ItemTriangleRight = function (data, options) {
    links.Timeline.Item.call(this, data, options);
};

links.Timeline.ItemTriangleRight.prototype = new links.Timeline.Item();


links.Timeline.ItemTriangleRight.prototype.reflow = function () {
    var dom = this.dom,
        dotHeight = dom.dot.offsetHeight,
        dotWidth = dom.dot.offsetWidth,
        lineWidth = dom.line.offsetWidth,
...
links.Timeline.ItemTriangleRight.prototype.select = function (options) {
    var dom = this.dom;
	//console.log($("timeline-event-selected").css("border-color"));
	if( jQuery.isEmptyObject(options.highlightbkcolor) ) {
		dom.style.background = "";
		dom.style.borderColor = "";
		dom.tri.style.borderColor = "";
		dom.line.style.borderColor = "";
		dom.dot.style.borderColor = "";
		...
		dom.style.background = options.highlightbkcolor;
		dom.style.borderColor = options.highlightbkcolor;
		dom.tri.style.borderColor = "transparent #000000 transparent "+options.highlightbkcolor;
		dom.line.style.borderColor = options.highlightbkcolor;
		dom.dot.style.borderColor = options.highlightbkcolor;
	}
	if( jQuery.isEmptyObject(options.highlightfrcolor) )
	...
	//console.log(options.highlightfrcolor );
    links.Timeline.addClassName(dom, 'timeline-event-selected ui-state-active');
    links.Timeline.addClassName(dom.line, 'timeline-event-selected ui-state-active');
    links.Timeline.addClassName(dom.dot, 'timeline-event-selected ui-state-active');
	links.Timeline.addClassName(dom.tri, 'timeline-tri-selected ui-state-active');

};


links.Timeline.ItemTriangleRight.prototype.unselect = function () {
    var dom = this.dom;
	...
	if( jQuery.isEmptyObject(this.bkcolor) ) {
		...
		dom.style.background = this.bkcolor;
		dom.style.borderColor = this.bkcolor;
		dom.tri.style.borderColor = "transparent #000000 transparent "+this.bkcolor;
		dom.line.style.borderColor = this.bkcolor;
		dom.dot.style.borderColor = this.bkcolor;
	}
    ...
    links.Timeline.removeClassName(dom.line, 'timeline-event-selected ui-state-active');
    links.Timeline.removeClassName(dom.dot, 'timeline-event-selected ui-state-active');
	links.Timeline.removeClassName(dom.tri, 'timeline-tri-selected ui-state-active');

};


links.Timeline.ItemTriangleRight.prototype.createDOM = function () {
    // background box
    var divBox = document.createElement("DIV");
    divBox.style.position = "absolute";
    divBox.style.left = this.left + "px";
	...
	// triangle on upper end of line
    var divTri = document.createElement("DIV");
    divTri.style.position = "absolute";
    divTri.style.width  = "0px";
    divTri.style.height = "0px";
	if(this.bkcolor!="")
		divTri.style.borderColor = "transparent #000000 transparent "+this.bkcolor;
	else
		divTri.style.borderColor = "";
	divBox.tri = divTri;
...
links.Timeline.ItemTriangleRight.prototype.showDOM = function (container) {
    var dom = this.dom;
    if (!dom) {
        dom = this.createDOM();
    }
    ...
    if (dom.parentNode != container) {
        ...
        container.appendChild(dom);
        container.insertBefore(dom.line, container.firstChild);
		container.insertBefore(dom.tri, container.firstChild);
        // Note: line must be added in front of the this,
        //       such that it stays below all this
        container.appendChild(dom.dot);
        this.rendered = true;
...
links.Timeline.ItemTriangleRight.prototype.hideDOM = function () {
    var dom = this.dom;
    if (dom) {
        if (dom.parentNode) {
            dom.parentNode.removeChild(dom);
		...
		if (dom.tri && dom.tri.parentNode) {
            dom.tri.parentNode.removeChild(dom.tri);
        }
...
links.Timeline.ItemTriangleRight.prototype.updateDOM = function () {
    var divBox = this.dom;
    if (divBox) {
        var divLine = divBox.line;
        var divDot = divBox.dot;
		var divTri = divBox.tri;
        ...
        divLine.className = "timeline-event timeline-event-line ui-widget ui-state-default";
        divDot.className  = "timeline-event timeline-event-dot ui-widget ui-state-default";
        divTri.className  = " timeline-event-tri ui-widget ui-state-default";
		
        if (this.isCluster) {
            links.Timeline.addClassName(divBox, 'timeline-event-cluster ui-widget-header');
            links.Timeline.addClassName(divLine, 'timeline-event-cluster ui-widget-header');
            links.Timeline.addClassName(divDot, 'timeline-event-cluster ui-widget-header');
            links.Timeline.addClassName(divTri, 'timeline-event-cluster ui-widget-header');
        }
        ...
        if (this.className) {
            ...
            links.Timeline.addClassName(divLine, this.className);
            links.Timeline.addClassName(divDot, this.className);
			links.Timeline.addClassName(divTri, this.className);
        }
...
links.Timeline.ItemTriangleRight.prototype.updatePosition = function (timeline) {
    var dom = this.dom;
    if (dom) {
        var left = timeline.timeToScreen(this.start),
            axisOnTop = timeline.options.axisOnTop,
        ...
        if (axisOnTop) {
            line.style.top = axisHeight + "px";
            line.style.height = Math.max(this.top - axisHeight + (this.height/2), 0) + "px";
            dot.style.top = (axisHeight - this.dotHeight/2) + "px";
        }
        else {
            line.style.top = (this.top + this.height/2) + "px";
            line.style.height = Math.max(axisTop - this.top - (this.height/2), 0) + "px";
            dot.style.top = (axisTop - this.dotHeight/2) + "px";
        }
		
		var triangle = dom.tri;
		triangle.style.top = this.top + (this.height/2) + "px";
		triangle.style.left = (left - this.lineWidth/2) + "px";

    }
};


links.Timeline.ItemTriangleRight.prototype.isVisible = function (start, end) {
    if (this.cluster) {
        return false;
    }
...
links.Timeline.ItemTriangleRight.prototype.setPosition = function (left, right) {
    var dom = this.dom;

    dom.style.left = (left - this.width / 2) + "px";
    dom.line.style.left = (left - this.lineWidth / 2) + "px";
    dom.dot.style.left = (left - this.dotWidth / 2) + "px";
	dom.tri.style.left = (left - this.lineWidth / 2) + "px";
...
links.Timeline.ItemTriangleRight.prototype.getLeft = function (timeline) {
    var boxAlign = (timeline.options.box && timeline.options.box.align) ?
        timeline.options.box.align : undefined;
...
links.Timeline.ItemTriangleRight.prototype.getRight = function (timeline) {
    var boxAlign = (timeline.options.box && timeline.options.box.align) ?
        timeline.options.box.align : undefined;
 ...
 * @override
 */
links.Timeline.ItemRange.prototype.select = function (options) {
    var dom = this.dom;
	if( jQuery.isEmptyObject(options.highlightbkcolor) ) {
		dom.style.background = "";
		dom.style.borderColor = "";
 ...
 * @override
 */
links.Timeline.ItemFloatingRange.prototype.select = function (options) {
    var dom = this.dom;
	if( jQuery.isEmptyObject(options.highlightbkcolor) ) {
		dom.style.background = "";
		dom.style.borderColor = options.highlightbkcolor;
 ...
 * @override
 */
links.Timeline.ItemDot.prototype.select = function (options) {
    var dom = this.dom;
	if( jQuery.isEmptyObject(options.highlightbkcolor) ) {
		dom.style.background = "";
		dom.style.borderColor = "";
